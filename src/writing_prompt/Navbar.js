            ...
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className=" w-full md:w-auto" id="mobile-menu">
                    <ul className="flex space-x-2 mt-4 flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        <li>
                            <button onClick={() => setOrder('day')} className={"block py-2 pr-4 pl-3  bg-blue-700 rounded md:bg-transparent md:p-0 dark:text-gray-400 dark:hover:bg-gray-700" + makeActive(true)} >Day</button>
                        </li>
                        <li>
