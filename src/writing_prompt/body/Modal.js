                ...
                <div className="overflow-y-scroll overscroll-contain w-screen fixed h-screen dark:bg-gray-700 bg-white right-0 left-0 top-4 z-50 justify-center items-center md:inset-0">
                    <div className="relative max-w-3xl mx-auto" >
                        ...
                        <div className="flex justify-between items-start p-5 ">
                            ...
                            <button type="button" onClick={() => props.handleClose()} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="defaultModal">
